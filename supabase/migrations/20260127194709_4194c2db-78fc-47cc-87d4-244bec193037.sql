-- Fix search_path security for log_activity_change function
...
-- Fix search_path security for log_prospect_change function
CREATE OR REPLACE FUNCTION public.log_prospect_change()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path = public
